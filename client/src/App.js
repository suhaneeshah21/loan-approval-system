...
export default function App() {
  ...
  const styles = {
    ...
    card: { background: "#fff", border: "0.5px solid #e5e5e5", borderRadius: 12, padding: "1.5rem", marginBottom: "1.25rem" },
    ...
    input: { fontSize: 14, padding: "8px 10px", border: "0.5px solid #ccc", borderRadius: 8, background: "#fafafa", color: "#111", width: "100%" },
    hint: { fontSize: 11, color: "#aaa" },
    submitBtn: { width: "100%", padding: 12, fontSize: 15, fontWeight: 500, background: "#fff", border: "0.5px solid #ccc", borderRadius: 8, cursor: "pointer", marginTop: "0.5rem" },
